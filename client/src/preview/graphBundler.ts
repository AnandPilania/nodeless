...
/**
 * Walks the local import graph starting at entryPath, transpiling each JS/TS/JSX/TSX/Vue/Svelte
 * module with the provided transpile function, and collecting bare (non-relative) import
 * specifiers as externals to be resolved from esm.sh at runtime.
 */
